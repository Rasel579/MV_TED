...
object Configurations {
    const val APPLICATION_ID = "com.movieapp.mv_ted"
...
object LibVersion {
    ...
    //Picaso
    const val PICASO_VERSION = "2.71828"
    ...
    const val FIREBASE_CORE_VERSION = "20.1.0"
...
object ImageLoaders{
    const val picasso = "com.squareup.picasso:picasso:${LibVersion.PICASO_VERSION}"
}

object Firebase {
    const val messaging = "com.google.firebase:firebase-messaging:${LibVersion.FIREBASE_MESSAGING_VERSION}"
    const val core = "com.google.firebase:firebase-core:${LibVersion.FIREBASE_CORE_VERSION}"
...
object GoogleMaps {
    ...
    const val googleLocation = "com.google.android.gms:play-services-location:${LibVersion.GOOGLE_LOCATION}"
}
